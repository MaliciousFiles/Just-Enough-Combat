...
import io.github.maliciousfiles.pvpoverhaul.item.weapon.DaggerItem;
...
public class ItemInit {
    ...
    // STAGE 1 (stone)
    public static final ArmorSet CLOTH = register(new ArmorSet(ArmorSet.ArmorType.LIGHT, 4, 15, Ingredient.fromTag(ItemTags.WOOL), 0, 0, "cloth"))
            .head(1, PvPOverhaul.settings())
            .chest(2, PvPOverhaul.settings())
            .legs(2, PvPOverhaul.settings())
            .feet(1, PvPOverhaul.settings())
            .armorChangeHandler(new AttributeArmorChangeHandler(EntityAttributes.GENERIC_MOVEMENT_SPEED, "0b70f4ff-5b34-40b7-b546-a64231ad171f", 0.20, EntityAttributeModifier.Operation.MULTIPLY_BASE), true, false, false);
    public static final ArmorSet CARCASS = register(new ArmorSet(ArmorSet.ArmorType.MEDIUM, 3, 5, Ingredient.ofItems(Items.LEATHER, Items.ROTTEN_FLESH), 0, 0, "carcass"))
            .head(1, PvPOverhaul.settings())
            .chest(2, PvPOverhaul.settings())
            .legs(1, PvPOverhaul.settings())
            .feet(1, PvPOverhaul.settings())
            .armorChangeHandler(new CarcassArmorChangeHandler(), true, true, false);
    public static final ArmorSet BONE = register(new ArmorSet(ArmorSet.ArmorType.HEAVY, 7, 12, Ingredient.ofItems(Items.BONE), 0, 0, "bone"))
    ...
    public static final ArmorSet LEATHER = register(new ArmorSet(ArmorSet.ArmorType.LIGHT, 5, new int[] {1, 2, 3, 1}, 15, Ingredient.ofItems(Items.LEATHER), 0, 0, "leather"))
            .armorChangeHandler(new VanillaArmorChangeHandler(), true, false, false);

    // STAGE 2 (iron)
    public static final ArmorSet IRON = register(new ArmorSet(ArmorSet.ArmorType.MEDIUM, 15, new int[] {2, 5, 6, 2}, 15, Ingredient.ofItems(Items.IRON_INGOT), 0, 0, "iron"))
            .armorChangeHandler(new VanillaArmorChangeHandler(), true, false, false);
    public static final ArmorSet CHAIN = register(new ArmorSet(ArmorSet.ArmorType.LIGHT, 15, new int[] {1, 4, 5, 2}, 9, Ingredient.ofItems(Items.IRON_INGOT), 0, 0, "chain") {
    ...
    public static final ArmorSet STUDDED_LEATHER = register(new ArmorSet(ArmorSet.ArmorType.MEDIUM, 13, 13, Ingredient.ofItems(Items.LEATHER), 0, 0.025f, "studded_leather"))
            .armorChangeHandler(new StuddedLeatherArmorChangeHandler(), false, true,false);


    // WEAPONS
    public static final LanceItem LANCE = new LanceItem(ToolMaterials.IRON, 1, -2.8f, PvPOverhaul.settings().maxDamage(238));
    public static final Item SHURIKEN = new ShurikenItem(PvPOverhaul.settings().maxCount(16).group(PvPOverhaul.ITEM_GROUP));
    public static final DaggerItem DAGGER_ITEM = new DaggerItem(ToolMaterials.IRON,  3, -3.2f, PvPOverhaul.settings().maxDamage(100));
    ...
    public static final TrackedData<Integer> STUCK_SHURIKEN_DATA = DataTracker.registerData(PlayerEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, PvPOverhaul.identifier("dagger"), DAGGER_ITEM);
    }
