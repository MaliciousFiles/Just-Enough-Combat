...
public class LanceItem extends SwordItem implements EntityDamageCallback, TooltipHandler {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getAttributeModifiers(ItemStack stack, EquipmentSlot slot) {
        ...
        if (slot == EquipmentSlot.MAINHAND) builder.put(AttributeInit.ATTACK_REACH, new EntityAttributeModifier(ATTACK_REACH_MODIFIER, "Weapon modifier", 3, EntityAttributeModifier.Operation.ADDITION));
